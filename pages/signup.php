    ...
    <section class="signup-section section">
        <div class="signup-container container">
            ...
            <div class="signup-content container-content">
                ...
                <form class="signup-form content-form" action="" method="POST" enctype="multipart/form-data">
                    <input type="text" name="username" class="signup-input input" placeholder="Username:">
                    <input type="email" name="email" class="signup-input input" placeholder="Email:">
                    ...
                    <div class="avatar-input">
                        <label for="avatar" class="useravatar-label btn">User Avatar</label>
                        <input type="file" name="avatar" id="avatar" value="">
                        <input type="text" class="file-name" id="file-name" placeholder="Insert Your Avatar" readonly>
